...
`content/recruiter-summary.mdx` is the single source for the recruiter-summary block rendered on Home, About, and (Phases 2/3) the Projects and Blog indexes.
